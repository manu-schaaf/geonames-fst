...
COPY data/geonames/alternateNames/DE.txt /app/data/alternateNames/

ENTRYPOINT [ "/app/geonames-fst", "data/geonames/" , "--alternate", "/app/data/alternateNames/", "--host", "0.0.0.0", "--port", "8000" ]
